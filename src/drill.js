...
function loadAudios() {
  promises = [
    loadAudio('/touch-shodo/mp3/correct3.mp3'),
    loadAudio('/touch-shodo/mp3/incorrect1.mp3'),
    loadAudio('/touch-shodo/mp3/correct1.mp3'),
    loadAudio('/touch-shodo/mp3/stupid5.mp3'),
  ];
